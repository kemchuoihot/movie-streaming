        ...
        <div className="relative h-[800px]">
          ...
          <div className="absolute left-0 w-full h-full bg-gradient-to-r from-gray-950 bg-gray-950 bg-opacity-60 flex items-center justify-between lg:px-40 space-y-4">
            <div className="relative w-1/2 ml-10 lg:ml-0">
              ...
              <Skeleton width={150} height={50} className="rounded-lg !w-[100px] !h-[30px]  md:!w-[150px] md:!h-[50px]" />
            </div>
            <div className="relative w-1/2 mx-auto flex justify-center">
              <Skeleton
                // width={400}
                // height={500}
                className="rounded-lg mx-auto !h-[280px] !w-[190px] md:!h-[400px] md:!w-[300px] lg:!h-[530px] lg:!w-[400px]"
              />
            </div>
          </div>
        </div>
                    ...
                    >
                      <div className="rounded-lg shadow-lg">
                        <LazyLoadImage
                          ...
                          src={item.poster_url}
                          alt="poster"
                          className="w-[150px] h-64 md:w-[184px] md:h-80 object-cover rounded-lg hover:shadow-lg transition duration-300 hover:shadow-sky-950"
                        />
                        {/* <div className="p-4">
